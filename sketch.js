...
ground_image=loadImage("Background.jpg");
  girl_running=loadAnimation("tiger.png");
  zombie_running=loadAnimation("hunter.png");
  zombie_attack=loadAnimation("hunter.png");
  obstacle1=loadImage("obstacle1.png");
  zombie_idle=loadImage("hunter.png");
  jumpSound = loadSound("jump.mp3")
  dieSound = loadSound("die.mp3")
  checkPointSound = loadSound("checkPoint.mp3")
  gameOverImage=loadImage("gameOver1.png");
  restartImage=loadImage("restart1.png");
  girl_collided=loadImage("tiger.png");
  girlImage=loadImage("tiger.png");
}

function setup() {
 createCanvas(1000,600);
  
ground=createSprite(50,180,0,0);
...
ground.scale=1.2;
 ...
 // girl.velocityX=2;
  ...
  zombie=createSprite(80,410,600,10);
